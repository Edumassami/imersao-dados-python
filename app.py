...
with col_graf4:
    if not df_filtrado.empty:
        df_ds = df_filtrado[df_filtrado['cargo'].str.lower().str.contains('data scientist')]
        media_ds_pais = df_ds.groupby('residencia')['usd'].mean().nlargest(10).sort_values(ascending=False).reset_index()
